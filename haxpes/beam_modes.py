...
def enable_tender_beam():
    ...
    namespace = ip.user_global_ns
    bl.activate_mode("Tender", namespace=namespace)
...
def enable_soft_beam():
    ...
    bl.activate_mode("Soft", namespace=namespace)
    ...
    namespace["transfer_setup"] = transfer_setup
    beamselection.set("Soft").wait()
